...
\end{proof}
By definition, $B$ is a lossless expert model. In Appendix B, we further motivate the necessity of the Byzantine assumptions for any such lossless model to exist. However, given these assumptions, we may now consider how to approximate $B$.

\subsection{Sampling}
One simple approach to approximating $B$ which may spring to the mind of the statistician is to sample the quora of $B$. That is, to pick at random from all possible quora and consider this in place of $B$. As we will show, though this is trivial, it has appealing combinatorial properties. 
...
Substituting and rearranging, we can describe the lost on $Cor$ term of $B$ due to sampling:
