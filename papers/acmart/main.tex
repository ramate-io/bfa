...
Thus, we may naively project this into $\mathbb{R}^3$ by the identity inclusion $i(n) = n$ for each datum:
...
For each of these projections, we can anaylze the data of $B$ as a simplicial complex, as shown in Figure \protect\ref{fig:simplicial_complex}.
