...
We argue that coordinating state machine replicas presents an online decision problem for which Byzantine majority presents a lossless expert model.
...
The determination for correctness is given to us by our tautology above:

\begin{flalign*}
&Correct(Q(r')) = Q(r') \cap H \neq \emptyset \\
\end{flalign*}

Consistency is less obvious. For the purpose of this motivation, we will assume a sequence of state transitions $r'_1, r'_2, \cdots, r'_n$ which we will denote as $R'$. We will say that a quorum $Q(r'_j)$ is consistent if and only if its predecessor $Q(r'_{j-1})$ is consistent and the two quora intersect, i.e., $Q(r'_j) \cap Q(r'_{j-1}) \neq \emptyset$. Observe that the expansion records all the effects of previous state transitions satisfying our original semantic intent:

\begin{flalign*}
  &Consistent(Q(r'_j), R') = Consistent(Q(r'_{j-1})) \land Q(r'_j) \cap Q(r'_{j-1}) \neq \emptyset \\
  &= Q(r'_{0}) \cap Q(r'_{1}) \neq \emptyset \land \cdots \land Q(r'_{j-1}) \cap Q(r'_j) \neq \emptyset \\
\end{flalign*}
...
\begin{flalign*}
  &Obj(Q(r'), R') = Obj(Q(r'_{j-1}), R') \land Q(r'_j) \cap Q(r'_{j-1}) \cap H \neq \emptyset \\
  &= Obj(Q(r'_{0}), R') \land Q(r'_{1}) \cap Q(r'_{0}) \cap H \neq \emptyset \land \cdots \land Q(r'_j) \cap Q(r'_{j-1}) \cap H \neq \emptyset \\
\end{flalign*}
...
\begin{flalign*}
  &Loss(Q(r'), R') = \sum_{r'_i \in R'} Obj(Q(r'_i), R') \\
  &= \sum_{r'_i \in R'} Obj(Q(r'_{i-1}), R') \land Q(r'_i) \cap Q(r'_{i-1}) \neq \emptyset \land Q(r'_i) \cap H \neq \emptyset \\
  &= \sum_{r'_i \in R'} Obj(Q(r'_{i-2}), R') \land Q(r'_{i-1}) \cap Q(r'_{i-2}) \neq \emptyset \land Q(r'_{i-1}) \cap H \neq \emptyset \land \cdots \land Q(r'_i) \cap Q(r'_{i-1}) \neq \emptyset \land Q(r'_i) \cap H \neq \emptyset \\
\end{flalign*}
...
\textbf{Base cases:}
\begin{itemize}
    \item We asssume $Q(r'_0)$ is correct and consistent. We argue that any quorum surpassing $2f + 1$ replicas must contain at least $f+1$ honest replicas and is thus correct. We argue that it is consistent as does not have any predecessors. Thus, $Obj(Q(r'_0), R') = 1 \implies Loss(Q(r'_0), R') = 0$.
...
\begin{flalign*}
&Obj(Q(r'_j), R') = Obj(Q(r'_{j-1}), R') \land Q(r'_j) \cap Q(r'_{j-1}) \cap H \neq \emptyset \\
&Obj(Q(r'_{j-1}), R') = 1 \implies \\
&Obj(Q(r'_j), R') = 1 \land Q(r'_j) \cap Q(r'_{j-1}) \cap H \neq \emptyset \\
\end{flalign*}
