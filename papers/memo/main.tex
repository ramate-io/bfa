...
\section{Motivation}
The motivation for studying Byzantine fault-allowing protocols, as I have dubbed them, is derived primarily from two phenomena in the world of distributed computing: the need for fault-tolerant order and compute inefficiencies of Byzantine fault-tolerant replica-based protocols.
...
If we want to access more compute in a Byzantine fault-tolerant setting, an initial thought is to simply relax the requirement on order. Perhaps we can include fewer processes and allow our total order to fail with an acceptably low likelihood. 
...
\subsection{The RESAMPLE Protocol}
...
\subsection{The Loss of the RESAMPLE Protocol}
