...
\begin{flalign*}
  &\mathcal{R}_{C}(f, k) = \sum_{i = 2k + 1}^{\min(3k + 1, f)} \binom{f}{i} \cdot \binom{2f + 1}{3k + 1 - i} \\
\end{flalign*}

The total number of ways to select a $\text{Divine}$ subcommittee is:

\begin{flalign*}
  &\mathcal{S}_{D}(f, k) = \sum_{i = 2k + 1}^{\min(3k + 1, 2f + 1)} \binom{2f + 1}{i} \cdot \binom{f}{3k + 1 - i} \\
\end{flalign*}
...
\begin{flalign*}
  &\lim_{f \to \infty} Pr[C](\gamma, k) = \frac{1}{2} \forall k \in \mathbb{N}: k < f \\
\end{flalign*}
